...
namespace LibreriaMisOfertas
{
    public class administracionProducto
    {
        ...
        public StringBuilder listarTodoProductos(PlaceHolder holder)
        {
            ...
            string carne = "<img src='/imagenes/carne_molida.jpg' height='100px' weight='100px'>";
            string cristal = "<img src='/imagenes/cristal.jpg' height='100px' weight='100px'>";
            string heineken = "<img src='/imagenes/heineken.jpg' height='100px' weight='100px'>";
            string k10 = "<img src='/imagenes/k10.jpg' height='100px' weight='100px'>";
            string lavadora = "<img src='/imagenes/lavadora.jpg' height='100px' weight='100px'>";
            string lenovo = "<img src='/imagenes/lenovo_g4080.png' height='100px' weight='100px'>";
            string pantalon_hombre = "<img src='/imagenes/pantalon_hombre.jpg' height='100px' weight='100px'>";
            string powerade = "<img src='/imagenes/powerade.png' height='100px' weight='100px'>";
            string s9 = "<img src='/imagenes/s9.png' height='100px' weight='100px'>";
            ...
            if(reader.Read())
            {
                ...
                if(reader[1].ToString()!="Powerade")
                {
                    ...
                    consulta.Append("<td>"+ powerade + "</td>");
            ...
            if (reader.Read())
            {
                //while (reader.Read())
                //{         
                if (reader[1].ToString() != "Cerveza 1LT")
                {
                    consulta.Append("<tr>");
                    consulta.Append("<td>" + " " + reader[0] + " " + "</td>");
                    consulta.Append("<td>" + " " + reader[1] + " " + "</td>");
                    ...
                    consulta.Append("<td>" + " " + reader[3] + " " + "</td>");
                    //byte[] toByte = (byte[])reader[4];
                    consulta.Append("<td>" + heineken + "</td>");
                    consulta.Append("<td>" + " " + reader[5] + " unidades " + "</td>");
                    consulta.Append("<td>" + " " + reader[6] + " unidades " + "</td>");
                    consulta.Append("<td>" + " " + reader[7] + " " + "</td>");
                    consulta.Append("<td>" + " " + reader[8] + " " + "</td>");
            ...
            if (reader.Read())
            {
                //while (reader.Read())
                //{         
                if (reader[1].ToString() == "LG K10 (2017)")
                {
                    consulta.Append("<tr>");
                    consulta.Append("<td>" + " " + reader[0] + " " + "</td>");
                    consulta.Append("<td>" + " " + reader[1] + " " + "</td>");
            ...
            if (reader.Read())
            {
                //while (reader.Read())
                //{         
                if (reader[1].ToString() == "Bandeja Trutro de pavo molido 250 gramos")
                {
                    consulta.Append("<tr>");
                    consulta.Append("<td>" + " " + reader[0] + " " + "</td>");
                    consulta.Append("<td>" + " " + reader[1] + " " + "</td>");
            ...
            if (reader.Read())
            {
                //while (reader.Read())
                //{         
                if (reader[1].ToString() == "Galaxy S9 Plus 128GB USB Tipo C")
                {
                    consulta.Append("<tr>");
                    consulta.Append("<td>" + " " + reader[0] + " " + "</td>");
                    consulta.Append("<td>" + " " + reader[1] + " " + "</td>");
            ...
            if (reader.Read())
            {
                //while (reader.Read())
                //{         
                if (reader[1].ToString() != "Six Pack 350ml")
                {
                    consulta.Append("<tr>");
                    consulta.Append("<td>" + " " + reader[0] + " " + "</td>");
                    consulta.Append("<td>" + " " + reader[1] + " " + "</td>");
            ...
            if (reader.Read())
            {
                //while (reader.Read())
                //{         
                if (reader[1].ToString() == "Pantalon de hombre café XL")
                {
                    consulta.Append("<tr>");
                    consulta.Append("<td>" + " " + reader[0] + " " + "</td>");
                    consulta.Append("<td>" + " " + reader[1] + " " + "</td>");
                    ...
                    consulta.Append("<td>" + " " + reader[3] + " " + "</td>");
                    //byte[] toByte = (byte[])reader[4];
                    consulta.Append("<td>" + pantalon_hombre + "</td>");
                    consulta.Append("<td>" + " " + reader[5] + " unidades " + "</td>");
                    consulta.Append("<td>" + " " + reader[6] + " unidades " + "</td>");
                    consulta.Append("<td>" + " " + reader[7] + " " + "</td>");
                    consulta.Append("<td>" + " " + reader[8] + " " + "</td>");
            ...
            if (reader.Read())
            {
                //while (reader.Read())
                //{         
                if (reader[1].ToString() != "G4080 I7-5500k 4GB RAM DDR3 1TB HDD")
                {
                    consulta.Append("<tr>");
                    consulta.Append("<td>" + " " + reader[0] + " " + "</td>");
                    consulta.Append("<td>" + " " + reader[1] + " " + "</td>");
            ...
            if (reader.Read())
            {
                //while (reader.Read())
                //{         
                if (reader[1].ToString() == "Lavadora 13KG")
                {
                    consulta.Append("<tr>");
                    consulta.Append("<td>" + " " + reader[0] + " " + "</td>");
                    consulta.Append("<td>" + " " + reader[1] + " " + "</td>");
                    ...
                    consulta.Append("<td>" + " " + reader[3] + " " + "</td>");
                    //byte[] toByte = (byte[])reader[4];
                    consulta.Append("<td>" + lavadora + "</td>");
                    consulta.Append("<td>" + " " + reader[5] + " unidades " + "</td>");
                    consulta.Append("<td>" + " " + reader[6] + " unidades " + "</td>");
                    consulta.Append("<td>" + " " + reader[7] + " " + "</td>");
                    consulta.Append("<td>" + " " + reader[8] + " " + "</td>");
