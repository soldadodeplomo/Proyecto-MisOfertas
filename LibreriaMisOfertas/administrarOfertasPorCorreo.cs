...
namespace LibreriaMisOfertas
{
    public class administrarOfertasPorCorreo
    {
        ...
        public void enviarCorreoOferta(Consumidor cons)
        {
            if (cons.recibirOferta == 's')
            {
                ...
                using (var mensaje = new MailMessage(from, to))
                {
                    ...
                    mensaje.Body = listarOfertasPorCorreo(toDataTable());
                    smtp.Send(mensaje);
                }
            }
        }
        ...
        public Document generarPDF(Consumidor t)
        {
            ...
            if (File.Exists(@"C:\Users\nicolas\Source\Repos\Proyecto-MisOfertas\webMisOfertasResponsive\tempDocs\cupon_descuento_1_" + t.runConsumidor + ".pdf"))
            {
                File.Delete(@"C:\Users\nicolas\Source\Repos\Proyecto-MisOfertas\webMisOfertasResponsive\tempDocs\cupon_descuento_1_" + t.runConsumidor + ".pdf");
            }
            ...
            iTextSharp.text.pdf.PdfWriter writer = iTextSharp.text.pdf.PdfWriter.GetInstance(doc, new FileStream(@"C:\Users\nicolas\Source\Repos\Proyecto-MisOfertas\webMisOfertasResponsive\tempDocs\cupon_descuento_1_" + t.runConsumidor + ".pdf", FileMode.OpenOrCreate));
            doc.Open();

            puntosAcumulados.obtenerTodoPDF(cert, t);
            PdfPTable table = new PdfPTable(1);

            var logo = iTextSharp.text.Image.GetInstance(@"C:\Users\nicolas\Source\Repos\Proyecto-MisOfertas\webMisOfertasResponsive\imagenes\test.png");
            ...
            var barra = iTextSharp.text.Image.GetInstance(@"C:\Users\nicolas\Source\Repos\Proyecto-MisOfertas\webMisOfertasResponsive\tempDocs\barcode" + t.runConsumidor + ".png");
        ...
        public void generarCodigoBarras(Consumidor t)
        {
            ...
            barcodeImg.CreateDrawingImage(System.Drawing.Color.Black, System.Drawing.Color.White).Save(@"C:\Users\nicolas\Source\Repos\Proyecto-MisOfertas\webMisOfertasResponsive\tempDocs\barcode" + t.runConsumidor + ".png", System.Drawing.Imaging.ImageFormat.Png);
        ...
        public StringBuilder listarOfertasPorRubro(PlaceHolder place)
        {
            ...
            string carne = "<img src='/imagenes/carne_molida.jpg' height='200px' weight='200px'>";
            string cristal = "<img src='/imagenes/cristal.jpg' height='200px' weight='200px'>";
            string heineken = "<img src='/imagenes/heineken.jpg' height='200px' weight='200px'>";
            string k10 = "<img src='/imagenes/k10.jpg' height='200px' weight='200px'>";
            string lavadora = "<img src='/imagenes/lavadora.jpg' height='200px' weight='200px'>";
            ...
            string powerade = "<img src='/imagenes/powerade.png' height='200px' weight='200px'>";
            ...
            if (reader.Read())
            {
                if (reader[8].ToString() != "Powerade")
                {
                    consulta.Append("<td>" + powerade + "<br>" + reader[4] + "<br>" + reader[7] + " en " + reader[0] + "<br>" + "Precio referencia: $" + reader[5] + "<br>" + "Oferta disponible desde el " + reader[1] + " hasta el " + reader[2] + "</td>");
                }
            }
            if (reader.Read())
            {
                if (reader[8].ToString() != "Lavadora 13KG")
                {
                    consulta.Append("<td>" + lavadora + "<br>" + reader[4] + "<br>" + reader[7] + " en " + reader[0] + "<br>" + "Precio referencia: $" + reader[5] + "<br>" + "Oferta disponible desde el " + reader[1] + " hasta el " + reader[2] + "</td>");
                }
            }
            if (reader.Read())
            {
                if (reader[8].ToString() != "Six Pack 350ml")
                {
                    consulta.Append("<td>" + cristal + "<br>" + reader[4] + "<br>" + reader[7] + " en " + reader[0] + "<br>" + "Precio referencia: $" + reader[5] + "<br>" + "Oferta disponible desde el " + reader[1] + " hasta el " + reader[2] + "</td>");
                }
            }
            if (reader.Read())
            {
                if (reader[8].ToString() != "Cerveza 1LT")
                {
                    consulta.Append("<td>" + heineken + "<br>" + reader[4] + "<br>" + reader[7] + " en " + reader[0] + "<br>" + "Precio referencia: $" + reader[5] + "<br>" + "Oferta disponible desde el " + reader[1] + " hasta el " + reader[2] + "</td>");
                }
            }
            if (reader.Read())
            {
                if (reader[8].ToString() != "LG K10 (2017)")
                {
                    consulta.Append("<td>" + k10 + "<br>" + reader[4] + "<br>" + reader[7] + " en " + reader[0] + "<br>" + "Precio referencia: $" + reader[5] + "<br>" + "Oferta disponible desde el " + reader[1] + " hasta el " + reader[2] + "</td>");
                }
            }
            if (reader.Read())
            {
                if (reader[8].ToString() != "Bandeja Trutro de pavo molido 250 gramos")
                {
                    consulta.Append("<td>" + carne + "<br>" + reader[4] + "<br>" + reader[7] + " en " + reader[0] + "<br>" + "Precio referencia: $" + reader[5] + "<br>" + "Oferta disponible desde el " + reader[1] + " hasta el " + reader[2] + "</td>");
                }
            }
            consulta.Append("</tr>");
        ...
        public string listarOfertasPorCorreo(DataTable dt)
        {
            string mensaje = "";
            if (dt.Rows.Count == 0)
            {
