<%@ Page Title="" Language="C#" MasterPageFile="~/master/paginaMaestra.Master" AutoEventWireup="true" CodeBehind="deshabilitar_producto.aspx.cs" Inherits="webMisOfertasResponsive.vistas.administradorTienda.producto.deshabilitar_producto" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="body" runat="server">
    <p class="text-primary text-center" style="font-size: 30px;">DASHBOARD DESHABILITAR PRODUCTO</p>
    <div class="container" style="width:1500px;">
        <div class="panel panel-default">
            <div class="panel-heading" style="text-align:center;">DESHABILITAR PRODUCTO</div>
